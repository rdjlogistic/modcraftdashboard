...
class CompaniesApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new CompanyResource(Company::with(['city', 'categories', 'prices'])->get());
    }
    ...
    public function store(StoreCompanyRequest $request)
    {
        ...
        $company->prices()->sync($request->input('prices', []));
    ...
    public function show(Company $company)
    {
        ...
        return new CompanyResource($company->load(['city', 'categories', 'prices']));
    }
