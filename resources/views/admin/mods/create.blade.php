...
<div class="card ">
    ...
    <div class="card-body card-body-common">
        <form id="modForm" action="{{ route("admin.mods.store") }}" method="POST" enctype="multipart/form-data"
            class="row">
            @csrf

            <div class="col-lg-6">
                <div class="form-group  {{ $errors->has('name') ? 'has-error' : '' }}">
                    <label for="name">{{ trans('cruds.mod.fields.name') }}&nbsp;<span class="error">*</span></label>
                    <input type="text" id="name" name="name" class="form-control"
                        value="{{ old('name', isset($mod) ? $mod->name : '') }}">
                    @if($errors->has('name'))
                    <div class="error">
                        {{ $errors->first('name') }}
                    </div>
                ...
                <div class="form-group  {{ $errors->has('platform') ? 'has-error' : '' }}">
                    <label for="platform">{{ trans('cruds.mod.fields.platform') }}&nbsp;<span
            ...
            <div class="form-group col-lg-6 {{ $errors->has('app_id') ? 'has-error' : '' }}">
                <label for="app">{{ trans('cruds.mod.fields.apps') }}&nbsp;<span class="error">*</span></label>
            ...
            <div class="form-group col-lg-6 {{ $errors->has('createdby') ? 'has-error' : '' }}">
                <label for="createdby">{{ trans('cruds.mod.fields.createdby') }}&nbsp;<span
                        class="error">*</span></label>
                <input type="text" id="createdby" name="createdby" class="form-control"
                    value="{{ old('createdby', isset($mod) ? $mod->createdby : '') }}">
            ...
            <div class="form-group col-lg-6">
                <label for="logo">{{ trans('cruds.mod.fields.logo') }}&nbsp;<span class="error">*</span></label>
                ...
                <div class="error">{{ $errors->first('filepath')}}</div>
                @endif
                <p class="helper-block">
