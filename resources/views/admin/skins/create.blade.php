...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.skin.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.skins.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="skinimage" value="skinimage">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="skinsliderimages" value="skinsliderimages">
