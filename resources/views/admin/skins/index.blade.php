...
<div class="card">
    <div class="card-header">
        <h2 class="title-main">{{ trans('cruds.skin.title_singular') }} {{ trans('global.list') }}</h2>
    </div>
                        ...
                        <tr data-entry-id="{{ $skin->id }}">
                            ...
                            <td>
                                <a class="btn btn-xs btn-info btn-edit"
                                    href="{{ route('admin.skins.edit', $skin->id) }}">
                                    {{ trans('global.edit') }}
                                </a>

                                <form class="btn-delete-form" action="{{ route('admin.skins.destroy', $skin->id) }}"
