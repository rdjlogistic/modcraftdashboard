                ...
                <tbody>
                    @foreach($skins as $key => $skin)
                        ...
                        <tr data-entry-id="{{ $skin->id }}">
                            ...
                            <td>
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.skins.edit', $skin->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                
                                    <form action="{{ route('admin.skins.destroy', $skin->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
