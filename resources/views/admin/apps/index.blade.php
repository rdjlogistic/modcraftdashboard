...
@section('content')
    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.apps.create") }}">
...
<div class="card">
    ...
    <h2 class="title-main"> {{ trans('cruds.app.title_singular') }} {{ trans('global.list') }}</h2>
    </div>
...
<script>
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.apps.massDestroy') }}",
