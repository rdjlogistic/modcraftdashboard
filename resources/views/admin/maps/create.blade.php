...
<div class="card">
    <div class="card-header">
        <h2 class="title-main"> {{ trans('global.create') }} {{ trans('cruds.map.title_singular') }}</h2>
    </div>

    <div class="card-body card-body-common">
        <form id="mapForm" action="{{ route("admin.maps.store") }}" method="POST" enctype="multipart/form-data"
            class="row">
            @csrf
            <div class="col-lg-6">
                <div class="form-group  {{ $errors->has('name') ? 'has-error' : '' }}">
                    <label for="name">{{ trans('cruds.map.fields.name') }}&nbsp;<span class="error">*</span></label>
                    <input type="text" id="name" name="name" class="form-control"
                        value="{{ old('name', isset($map) ? $map->name : '') }}">
                    @if($errors->has('name'))
                    <div class="error">
                        {{ $errors->first('name') }}
                    </div>
                ...
                <div class="form-group {{ $errors->has('platform') ? 'has-error' : '' }}">
                    <label for="platform">{{ trans('cruds.map.fields.platform') }}&nbsp;<span
            ...
            <div class="form-group col-lg-6 {{ $errors->has('app_id') ? 'has-error' : '' }}">
                <label for="app">{{ trans('cruds.map.fields.apps') }}&nbsp;<span class="error">*</span></label>
                <select name="app_id" id="app" class="form-control select2">
            ...
            <div class="form-group col-lg-6 {{ $errors->has('createdby') ? 'has-error' : '' }}">
                <label for="createdby">{{ trans('cruds.map.fields.createdby') }}&nbsp;<span
                        class="error">*</span></label>
                <input type="text" id="createdby" name="createdby" class="form-control"
                    value="{{ old('createdby', isset($map) ? $map->createdby : '') }}">
            ...
            <div class="form-group col-lg-6">
                <label for="logo">{{ trans('cruds.map.fields.logo') }}&nbsp;<span class="error">*</span></label>
